...
public class CheckImportantAnswersTests {
    ...
    public CheckImportantAnswersTests(String answer, String index) {
        this.answer = answer;
        this.index = index;
    }
    ...
    @Test
    public void checkImportantAnswersTests() {
        driver.get("https://qa-scooter.praktikum-services.ru/");
        MainPage mainPage = new MainPage(driver);
        String answerText = mainPage.getAnswer(index);
        assertEquals("Текст ответа не совпадает с ожидаемым", answer, answerText);
    }
